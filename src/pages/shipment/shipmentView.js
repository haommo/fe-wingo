    ...
    <Menu>
      <Menu.Item key="1">
        <Button
          type="primary"
          onClick={showModal}
          style={{ padding: '10px', display: 'flex', flexDirection: 'row', alignItems: 'center', width: '170px' }}
        >
          <PrintIcon style={{ marginRight: '20px' }} />
          Print HAWB
        </Button>
      </Menu.Item>
      <Menu.Item key="2">
            ...
            <Stack direction="row" justifyContent="flex-end" spacing={1}>
                  ...
                  <PDFDownloadLink
                    ...
                    document={
                      <ReactPDF
                        ...
                        packageInfo={shipmentData?.shipment_package_info || []}
                        product={shipmentData?.shipment_product_info || []}
                      />
                    }
                    fileName={'Bill ' + shipmentData?.shipment.hawb + '.pdf'}
                  >
              ...
              <Modal
                ...
                footer={[
                  ...
                  <PDFDownloadLink
                    key="AWB"
                    document={<AWB shipment={shipmentData?.shipment || {}} packageInfo={shipmentData?.shipment_package_info || []} />}
                    fileName={'AWB ' + shipmentData?.shipment.hawb + '.pdf'}
                  >
              ...
              <MainCard>
                <Stack spacing={1}>
                  ...
                  <Stack spacing={0.5} direction="row">
                    ...
                    <Typography color="secondary" sx={{ paddingRight: 5 }}>
                      {shipmentData?.shipment?.sender_address?.city}{' '}
                    </Typography>
                  ...
                  <Stack spacing={0.5} direction="row">
                    ...
                    <Typography color="secondary" sx={{ paddingRight: 5 }}>
                      {getCountryDisplayName(shipmentData?.shipment?.sender_address?.country)}{' '}
                    </Typography>
              ...
              <MainCard>
                <Stack spacing={1}>
                  ...
                  <Stack spacing={0.5} direction="row">
                    <Typography color="secondary">{`City:`}</Typography>
                    <Typography color="secondary" sx={{ paddingRight: 5 }}>
                      {shipmentData?.shipment?.receiver_address?.city}
                    </Typography>
                    <Typography color="secondary">{`State:`}</Typography>
                  ...
                  <Stack spacing={0.5} direction="row">
                    <Typography color="secondary">{`Country:`}</Typography>
                    <Typography color="secondary" sx={{ paddingRight: 5 }}>
                      {getCountryDisplayName(shipmentData?.shipment?.receiver_address?.country)}{' '}
                    </Typography>
                    <Typography color="secondary">{`Zipcode:`}</Typography>
