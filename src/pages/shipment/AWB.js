          ...
          <View style={styles.section}>
            <View style={styles.header}>
              ...
              <View style={styles.barcode}>
                ...
                <Text style={styles.fontSpc}>WINGO LOGISTICS</Text>
              </View>
            </View>
            <View
              style={{
            ...
            >
              <Text style={{ fontSize: '25px', textAlign: 'center', paddingTop: '8px', paddingBottom: '8px', fontWeight: 'bold' }}>
              SHIPPING MARK 
              </Text>
            </View>
            <View
            ...
            >
              <Text style={{ fontSize: '40px', padding: '15px', fontWeight: 'bold' }}>
                {props.shipment.hawb ? props.shipment.hawb : '1'}
              </Text>
            </View>
            <View
              style={{
            ...
            >
              <Text style={{ fontStyle: 'italic', width: '100%', marginLeft: '20PX' }}>Pcs no:</Text>
              <Text style={{ fontSize: '40px', textAlign: 'center', letterSpacing: '10px', marginRight: '245px' }}>
                {index + 1} / {props.packageInfo.length}
              </Text>
            </View>
            <View
              style={{
            ...
            <View style={styles.senderPanel}>
              ...
              <View style={styles.senderContents}>
                ...
                <Text style={styles.senderContent}>
                  {props.shipment.receiver_address ? props.shipment.receiver_address.address_second : ''}
                </Text>
              ...
              <View style={styles.senderEndsContents}>
                ...
                <Text style={styles.senderEndContent}>
                  {props.shipment.receiver_address ? props.shipment.receiver_address.zipCode : ''}
                </Text>
